...
def get_answer_and_source_text(df, answer_filename):
    """
    Finds the correct row in dataframe based on filename and returns the text. Does this for
    both the answer text and the source text.
    
    Args:
        df (pd.Dataframe): stores the answers and sources
        answer_filename (string): filename for the answer, to be used to find the text
        
    Returns: 
        answer_text, source_text
    """
    print('Getting answer and source texts...\n')
